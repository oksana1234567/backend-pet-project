...
export const manageModelsChangesFavorite = (user: Users, article: Articles ) => {
    user.favorites.push({ article: article });
    article.favorited = true;
    article.favoritesCount += 1;
};

export const manageModelsChangesUnFavorite = (user: Users, article: Articles, slug: string ) => {
